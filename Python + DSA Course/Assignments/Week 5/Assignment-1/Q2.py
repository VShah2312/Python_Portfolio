"""
Question 2: Make a dictionary with keys as subject name (physics, chemistry, etc.)
...
print(subject, subject_marks[subject])

# OR
key = list(subject_marks.keys())
value = list(subject_marks.values())
highest_index = value.index(max(value))
print(key[highest_index], max(value))
