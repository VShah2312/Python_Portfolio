"""
Question 3: Write a Python function that takes a dictionary as input where the
...
def function(my_dict: Dict[str, list]) -> Dict:
    result = {}
    for k, v in my_dict.items():
        result[k] = [i for i in v if i % 2 == 0]
    return result


dict = {"A": [1, 2, 3, 4], "B": [4, 5, 6, 8]}
print(function(dict))
