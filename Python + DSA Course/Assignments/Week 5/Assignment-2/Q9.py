"""
Question 9: Given a dictionary with key-value pairs, remove all the keys with values 
...
def function(my_dict: Dict[str, int], k):
    result = {}
...
test_dict = {"Gfg": 3, "is": 7, "best": 10, "for": 6, "qqqq": "CS"}
k = 7
print(function(test_dict, k))
