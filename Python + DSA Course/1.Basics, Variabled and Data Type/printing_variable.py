...
print(f"name ={name}") # We can check what values is currently assigned to a particular variable name. Doesnt show data type

print(f"{name = }") # (this gives name result as above) name= 'Vrunda', also shows name is in string data type. 
print(f"age= {age}")
print(f"{name =},{age = }")